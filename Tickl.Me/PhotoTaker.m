...
- (void) initialSettings {
    ...
    UIImageView* back1 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 44)];
    back1.backgroundColor = [UIColor blackColor];
    back1.image = [UIImage imageNamed:@"transparent.png"];
    
    self.photoButton = [UIButton buttonWithType:UIButtonTypeCustom];
    self.photoButton.frame = CGRectMake(105,  self.view.frame.size.height-44, 110, 44);
    ...
    libraryBtn.frame = CGRectMake(52,0, 53, 44);
    ...
    UIImageView* back = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height-44, 320, 44)];
    back.backgroundColor = [UIColor blackColor];
    back.image = [UIImage imageNamed:@"transparent.png"];
    ...
    cancelButton.frame = CGRectMake(0, 0, 52, 44);
    ...
    autoMainBtn.frame = CGRectMake(106, 0, 106, 44);
    ...
    offButton.frame = CGRectMake(106, 50, 106, 50);
    ...
    onButton.frame = CGRectMake(106, 100, 106, 50);
    ...
    autoBtn.frame = CGRectMake(106, 150, 106, 50);
